...
"""
Inflow = pd.read_excel(r'pso_data(1985-2014).xlsx', sheet_name='Inflow(1.00)2003')  # here if pso_data1.xlsx(1978-1980) replaced by pso_data.xlsx the code will take input for 47 years(1968-2014)
Start = Inflow['Date'][0]
